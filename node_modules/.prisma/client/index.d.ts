...
export namespace Prisma {
  ...
  */
  ...
  export type PrestadorSelect = {
    ...
    email?: boolean
    Senha?: boolean
    servico?: boolean | ServicoFindManyArgs
  ...
  export class Prisma__PrestadorClient<T, Null = never> implements PrismaPromise<T> {
    ...
    servico<T extends ServicoFindManyArgs= {}>(args?: Subset<T, ServicoFindManyArgs>): PrismaPromise<Array<ServicoGetPayload<T>>| Null>;
  ...
  export class Prisma__AgendadoClient<T, Null = never> implements PrismaPromise<T> {
    ...
    cliente<T extends ClienteFindManyArgs= {}>(args?: Subset<T, ClienteFindManyArgs>): PrismaPromise<Array<ClienteGetPayload<T>>| Null>;
